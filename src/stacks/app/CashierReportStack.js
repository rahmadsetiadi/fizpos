...
// screens
import CashierReport from '../../screens/app/cashierReport/CashierReportScreen';
    ...
    return (
        <View style={{ flexDirection: 'row' }}>
            ...
            <View style={{ flex: 0.7, marginHorizontal: wp('3%') }}>
                <Title style={{ ...styles.textJudul, color: Constant.colorTextPrimary }}>Cashier Report</Title>
            </View>
        </View>
    );
}

const CashierReportStack = (props) => {
    useEffect(() => {
    ...
    return (
        <Stack.Navigator initialRouteName="CashierReport">
            <Stack.Screen
                name="CashierReport"
...
export default CashierReportStack;