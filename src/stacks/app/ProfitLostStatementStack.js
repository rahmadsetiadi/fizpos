...
// screens
import ProfitLostStatement from '../../screens/app/profitLostStatement/ProfitLostStatementScreen';
    ...
    return (
        <View style={{ flexDirection: 'row' }}>
            ...
            <View style={{ flex: 0.7, marginHorizontal: wp('3%') }}>
                <Title style={{ ...styles.textJudul, color: Constant.colorTextPrimary }}>Profit & Lost Statement</Title>
            </View>
        </View>
    );
}

const ProfitLostStatementStack = (props) => {
    useEffect(() => {
    ...
    return (
        <Stack.Navigator initialRouteName="ProfitLostStatement">
            <Stack.Screen
                name="ProfitLostStatement"
                component={ProfitLostStatement}
                options={{
                    headerTitle: 'FIZPOS',
...
export default ProfitLostStatementStack;