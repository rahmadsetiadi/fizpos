...
// screens
import WeeklyMonthlyReport from '../../screens/app/weeklyMonthlyReport/WeeklyMonthlyReportScreen';
    ...
    return (
        <View style={{ flexDirection: 'row' }}>
            ...
            <View style={{ flex: 0.7, marginHorizontal: wp('3%') }}>
                <Title style={{ ...styles.textJudul, color: Constant.colorTextPrimary }}>Weekly & Monthly Report</Title>
            </View>
        </View>
    );
}

const WeeklyMonthlyReportStack = (props) => {
    useEffect(() => {
    ...
    return (
        <Stack.Navigator initialRouteName="WeeklyMonthlyReport">
            <Stack.Screen
                name="WeeklyMonthlyReport"
                component={WeeklyMonthlyReport}
                options={{
                    headerTitle: 'FIZPOS',
...
export default WeeklyMonthlyReportStack;