...
// screens
import CogsReport from '../../screens/app/cogsReport/CogsReportScreen';
    ...
    return (
        <View style={{ flexDirection: 'row' }}>
            ...
            <View style={{ flex: 0.7, marginHorizontal: wp('3%') }}>
                <Title style={{ ...styles.textJudul, color: Constant.colorTextPrimary }}>Cogs Report</Title>
            </View>
        </View>
    );
}

const CogsReportStack = (props) => {
    useEffect(() => {
    ...
    return (
        <Stack.Navigator initialRouteName="CogsReport">
            <Stack.Screen
                name="CogsReport"
...
export default CogsReportStack;