...
// screens
import RevenueSummary from '../../screens/app/revenueSummary/RevenueSummaryScreen';
    ...
    return (
        <View style={{ flexDirection: 'row' }}>
            ...
            <View style={{ flex: 0.7, marginHorizontal: wp('3%') }}>
                <Title style={{ ...styles.textJudul, color: Constant.colorTextPrimary }}>Revenue Summary</Title>
            </View>
        </View>
    );
}

const RevenueSummaryStack = (props) => {
    useEffect(() => {
    ...
    return (
        <Stack.Navigator initialRouteName="RevenueSummary">
            <Stack.Screen
                name="RevenueSummary"
...
export default RevenueSummaryStack;