...
// screens
import PaymentSummary from '../../screens/app/paymentSummary/PaymentSummaryScreen';
    ...
    return (
        <View style={{ flexDirection: 'row' }}>
            ...
            <View style={{ flex: 0.7, marginHorizontal: wp('3%') }}>
                <Title style={{ ...styles.textJudul, color: Constant.colorTextPrimary }}>Payment Summary</Title>
            </View>
        </View>
    );
}

const PaymentSummaryStack = (props) => {
    useEffect(() => {
...
export default PaymentSummaryStack;