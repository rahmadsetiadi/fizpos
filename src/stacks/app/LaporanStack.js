...
// screen
import LaporanMain from '../../screens/app/laporan/LaporanMain';
    ...
    return (
        <View style={{ flexDirection: 'row' }}>
            ...
            <View style={{ flex: 0.7, marginHorizontal: wp('3%') }}>
                <Title style={{ ...styles.textJudul, color: Constant.colorTextPrimary }}>Laporan</Title>
            </View>
        </View>
    );
}

const LaporanStack = (props) => {
    useEffect(() => {
    ...
    return (
        <Stack.Navigator initialRouteName="LaporanMain">
            <Stack.Screen
                name="LaporanMain"
                component={LaporanMain}
                options={{
                    headerTitle: 'FIZPOS',
